...
namespace brfd {
  ...
  gf::MessageStatus StoryModel::onHeroPosition([[maybe_unused]] gf::Id id, gf::Message *msg) {
    if (m_state != State::Running) {
  ...
  gf::MessageStatus StoryView::onHeroPosition([[maybe_unused]] gf::Id id, gf::Message *msg) {
